...
class PlaneTest {
    ...
    void testFindIntersections() {
        ...
        // T16: Ray is neither orthogonal nor parallel to and begins at the plane - p0 is in the plane, but not the ray.
        assertNull(plane.findIntersections(new Ray(new Point(1, 1, 0), new Vector(0, 1, -1))),
                "Ray's line out of plane");

        // T17: Ray is neither orthogonal nor parallel to the plane and begins in the same point which appears as reference point in the plane - p0.
