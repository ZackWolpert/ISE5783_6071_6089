...
class CylinderTest {
    ...
    @Test
    void testGetNormal() {
        Cylinder cylinder = new Cylinder(4d,new Ray(
                new Point(0, 0, 0),
                new Vector(0, 1, 0)), 4);

        // ============ Equivalence Partitions Tests ==============
        // TC01: Test normal to cylinder at side - normal length being equal to 1)
        var normal = cylinder.getNormal(new Point(4, 1, 0));
